...
public class InternalApiIntegrationTest {
    ...
    private final String BASE_URL = "/internal-api";

    @Autowired
    private MockMvc mockMvc;

    /* TESTING INTERNAL API CONTROLLER */
    @Test
    ...
    @Test
    void getHome_returns200_OkResponse_ifAuthorizedAs_internalApiUser() throws Exception {
        this.mockMvc
                .perform(get(BASE_URL + "/resource").header(AUTH_HEADER, getInternalUserAuthHeader()))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string("Dear fairyprincess@gmail.com, you have been authorized and got 'INTERNAL RESOURCE'"));
    }

    @Test
    void getHome_returns403_ForbiddenResponse_ifAuthorizedAs_externalApiUser() throws Exception {
        this.mockMvc
